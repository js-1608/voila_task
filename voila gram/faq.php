...
<section class="section_faq">
    <div class="sidebar"> 
      <ul id="main-headings">
        ...
        <li data-target="section4">&#9734;  Market Place</li>
        <li data-target="section5"> &#9734; Fashion portal</li>
        <li data-target="section6">&#9734;  Payment</li>
        <li data-target="section7"> &#9734; Sign up and Login</li>
        <li data-target="section8"> &#9734; Policy</li>
        <li data-target="section9"> &#9734; Other Questions</li>
      </ul>
    </div>
    <div class="content">
        ...
        <div class="container">
          <div class="faq">
            ...
            <div class="faq-item">
              ...
              <div class="faq-answer">
                <p class="faq_answer">
                Yes, we offer consultancy
                 services to help businesses 
                 navigate the e-commerce landscape. Our experts 
                 provide strategic insights and solutions for sustainable growth.
                  To learn more, visit our VOILA Biz vertical
                   at [VOILAbiz.com](https://VOILAbiz.com/), or contact our customer
                   executives using the phone numbers and emails listed in the contact section.
                </p>
              </div>
            </div>
            <div class="faq-item">
              <div class="faq-question">
                <h3 class="hoverText">
                What makes VOILA Studio different from other e-commerce photography studios? 
                </h3>
              </div>
              <div class="faq-answer">
                <p class="faq_answer">
        ...
        <div class="container">
          <div class="faq">
            ...
            <div class="faq-item">
              ...
              <div class="faq-answer">
                <p class="faq_answer">
                MSQ, or Minimum Shoot Quantity,
                 refers to the minimum number of
                  shoots required for availing
                   our e-commerce photography services.
                    At VOILA Studio, it's set at a minimum
                     of 50 shoots per client to ensure the
                      best quality and service for your e-commerce needs.
                </p>
              </div>
            </div>
            <div class="faq-item">
          ...
          <div class="faq-item">
            <div class="faq-question">
              <h3 class="hoverText">How to use model calendar for booking </h3>
            </div>
            <div class="faq-answer">
              <p class="faq_answer">
              To use the model calendar for booking your e-commerce photoshoot:
                     1. Navigate to the "Calendar" section in the header.
                     2. Choose the type of shoot you need: men, women, or kids.
                     3. View available models and their profiles, including upcoming and booked slots.
                     4. Select your desired model and product category.
                     5. Customize your shoot options, if needed.
                     6. Specify your shoot requirements, such as marketplace or fashion portal.
                     7. Enter product quantity and your location details.
                     8. Confirm your shoot date and time.
                     9. If necessary, you can change the model before finalizing.
                     10. Complete the booking process.

                      For more details, visit "How can I book a photoshoot with VOILA Studio?" section.              </p>
            </div>
          </div>
          <div class="faq-item">
            <div class="faq-question">
              <h3 class="hoverText">How to use product calendar for booking </h3>
            </div>
            <div class="faq-answer">
              <p class="faq_answer">
              1. Click on "Calender" in the header.
                              2. Choose "Product Photoshoot" from the category.
                                     3. View upcoming shoots and available slots.
                                  4. Click "Book Now" for your preferred date.
                            5. Select your product category.
                           6. Proceed to the shoot page, add additional options if needed.
                          7. Choose your shoot purpose (marketplace, fashion portal, etc.).
                     8. Enter product quantity and pin code.
                     9. Confirm your shoot date and time.
              10. Complete the booking process.</div>
          </div>
          <div class="faq-item">
            <div class="faq-question">
          ...
          <div class="faq-item">
            <div class="faq-question">
              <h3 class="hoverText">
              How to shipped your product
              </h3>
            </div>
            <div class="faq-answer">
              <p class="faq_answer">
              Shipping your product is easy! Simply choose your preferred delivery agency, whether it's a local service or one you trust. Make sure to keep track of your shipment by noting down the tracking ID provided. For more details or assistance, feel free to reach out to us via email or phone.
              </p>
            </div>
          </div>
          <div class="faq-item">
            <div class="faq-question">
              <h3 class="hoverText">How much time will it take for your product to reach us for an e-commerce photoshoot?</h3>
            </div>
            <div class="faq-answer">
              <p class="faq_answer">
              At VOILA Studio, we understand the importance of time in the fast-paced world of e-commerce. Generally, it takes about 3 to 5 days for your product to reach us for a photoshoot. However, delivery times may vary depending on the delivery partner and their timelines.
              </p>
            </div>
          </div>
          <div class="faq-item">
            <div class="faq-question">
              <h3 class="hoverText">
              What is 360 video ecommerce photoshoots?
              </h3>
            </div>
            <div class="faq-answer">
              <p class="faq_answer">
              360 video shoots involve capturing footage in all directions simultaneously, providing viewers with an immersive experience where they can look around in any direction as if they're present at the scene. These shoots typically use specialized cameras equipped with multiple lenses to record a full panoramic view. The resulting footage is then stitched together to create a seamless 360-degree video. This technology is often used in virtual reality (VR) experiences, interactive storytelling, tourism, real estate, and entertainment, offering audiences a more engaging and interactive way to explore environments and narratives.
              </p>
            </div>
          </div> 
           <div class="faq-item">
            <div class="faq-question">
              <h3 class="hoverText">How do I cancel the order, I have placed?</h3>
            </div>
            <div class="faq-answer">
              <p class="faq_answer">
              To cancel your order for an ecommerce photoshoot, simply reach out to us via email or phone provided on our website. We'll assist you promptly.
              </p>
            </div>
          </div> 
           <div class="faq-item">
            <div class="faq-question">
              <h3 class="hoverText">What types of product photography do you provide?    </h3>
            </div>
            <div class="faq-answer">
              <p class="faq_answer">
              Our product photography services include creative shoots, ghost shoots, hanger shoots, flatlay shoots, and more. We focus on high-quality, realistic, and candid images to enhance your products' online presence.
              </p>
            </div>
          </div> 
           <div class="faq-item">
            <div class="faq-question">
              <h3 class="hoverText">
              Can you handle model shoots for e-commerce platforms?    
              </h3>
            </div>
            <div class="faq-answer">
              <p class="faq_answer">
              Yes, we provide professional model shoots for men, women, and kids. Our team is experienced in creating compelling images for platforms like Amazon, Flipkart, Myntra, Ajio, and many more.
              </p>
            </div>
          </div> 
           <div class="faq-item">
            <div class="faq-question">
              <h3 class="hoverText">Do you offer specialized shoots like ghost or flatlay photography?    </h3>
            </div>
            <div class="faq-answer">
              <p class="faq_answer">
              Absolutely. We offer specialized shoots including ghost photography, which creates a hollow man effect for apparel, and flatlay photography, ideal for displaying products in a creative, overhead layout
              </p>
            </div>
          </div> 
           <div class="faq-item">
            <div class="faq-question">
              <h3 class="hoverText">How can I book model photoshoot with VOILA Studio?    </h3>
            </div>
            <div class="faq-answer">
              <p class="faq_answer">
              You can schedule a shoot by following these steps:
                      •	Choose the category.
                      •	Select a model, then click on "Book Shoot."
                      •	Optionally, select additional options described there. Otherwise, choose your desired shoot.
                      •	Enter the quantity of products in the quantity column and your pin code.
                      •	Once you've booked the shoot, you'll be redirected to the payment page with all your booking information. If you need to make changes, click on "Modify"; otherwise, click on "Continue."
                      •	Fill in your details and proceed with payment.
                      •	Your order is now booked.  
              </p>
            </div>
          </div> 
           <div class="faq-item">
            <div class="faq-question">
              <h3 class="hoverText">
              What is the process for scheduling a model or product photoshoot?
              </h3>
            </div>
            <div class="faq-answer">
              <p class="faq_answer">
              To schedule a shoot, you can use our online calendar for model and product bookings. Alternatively, contact us directly for personalized assistance and scheduling.
              </p>
            </div>
          </div> 
           <div class="faq-item">
            <div class="faq-question">
              <h3 class="hoverText">How do you ensure the quality of your photographs?    </h3>
            </div>
            <div class="faq-answer">
              <p class="faq_answer">
              We use top-notch cameras and clever methods to make them look great. Our team works hard to create pictures that catch people's eyes when they're shopping online.
              </p>
            </div>
          </div> 
           <div class="faq-item">
            <div class="faq-question">
              <h3 class="hoverText">What are the pricing details for your photoshoot services?    </h3>
            </div>
            <div class="faq-answer">
              <p class="faq_answer">
              In an online marketplace, the cost of services changes based on what you need. You can see different prices for different types of services, like photoshoots and angles. When you choose what you want, the website figures out how much it will cost you. If you need more details, just get in touch with us and we'll give you a personalized price.
              </p>
            </div>
          </div> 
           <div class="faq-item">
            <div class="faq-question">
              <h3 class="hoverText">How can I manage my orders with VOILA Studio?    </h3>
            </div>
            <div class="faq-answer">
              <p class="faq_answer">
              You can manage your orders through our website by accessing the "Manage Orders" section. For further assistance, our customer support team is always available to help.
              </p>
            </div>
          </div> 
           <div class="faq-item">
            <div class="faq-question">
              <h3 class="hoverText">Do you provide on-location shoots or only in-studio services?    </h3>
            </div>
            <div class="faq-answer">
              <p class="faq_answer">
              We currently offer our photography services exclusively in our studios. All model and product shoots are conducted in our well-equipped studios to ensure the highest quality results.
              </p>
            </div>
          </div> 
           <div class="faq-item">
            <div class="faq-question">
              <h3 class="hoverText">Do you provide models for the photoshoots?</h3>
            </div>
            <div class="faq-answer">
              <p class="faq_answer">
              No, we do not provide models for the photoshoots. (At VOILA Studio, our professional photographers will capture your eCommerce photoshoots using our top models in our studio.)
              </p>
            </div>
          </div>
        </div>
      ...
      <div id="section4" class="faq-section">
        ...
        <div class="container">
          <div class="faq">
            ...
            <div class="faq-item">
              <div class="faq-question">
                <h3 class="hoverText">How many premium shoots do you offer for a single product for the marketplace?</h3>
              </div>
              <div class="faq-answer">
                <p class="faq_answer">
                At VOILA Studio, we offer 6 premium shoots for a single product of ecommerce photoshoots in the marketplace.                </p>
              </div>
            </div>
            <div class="faq-item">
              <div class="faq-question">
                <h3 class="hoverText">Duration of a video as for market portal </h3>
              </div>
              <div class="faq-answer">
                <p class="faq_answer">
                At VOILA Studio, the minimum duration for a market place video is 10 seconds. Beyond that, the length can be customized according to your specific requirements. For more details or to discuss your project, please reach out to us via email at info@VOILAstudio.in or call us at +91 9810554548.

                      Keywords: Models for shoot, ecommerce shoot, ecommerce photoshoot, studio for product photography, VOILA Studio, ecommerce photography services, product photography ecommerce, fashion video shoot.
                </p>
              </div>
            </div>
            <div class="faq-item">
      ...
      <div id="section6" class="faq-section">
        ...
        <div class="container">
          <div class="faq">
            ...
            <div class="faq-item">
              <div class="faq-question">
                <h3 class="hoverText">what is GST and Do we apply GST amount?</h3>
              </div>
              <div class="faq-answer">
                <p class="faq_answer">
                GST, or Goods and Services Tax, is a single tax on the supply of goods and services, which is levied on every value addition made along the supply chain. It's added to a product's sale price and is ultimately borne by the end consumer. If your order is fulfilled on or after July 1st, 2017, GST will be applicable. Yes, we do apply GST amount on booking orders of our ecommerce photoshoot services in India.
                </p>
              </div>
            </div>
            <div class="faq-item">
      ...
      <div id="section7" class="faq-section">
        ...
        <div class="container">
          ...
          <div class="faq-item">
              <div class="faq-question">
                <h3 class="hoverText">How do I login/signup an account on VOILA Studio?</h3>
              </div>
              <div class="faq-answer">
                <p class="faq_answer">
                To create an account on VOILA Studio:

                              If you already have an account:
                        1. Click on "Profile" in the top right corner of the website.
                           2. Select "Login/Signup."
                     3. Enter your mobile number and password.
                           4. Click "Login" to access your account and explore our services.
                   ...
                   If you need to sign up:
                     ...
                     4. Fill out all the required information.
                       5. Agree to the terms and conditions.
                          6. Click "Signup Now" to complete the process.
                       Now, you're all set to make bookings and discover our services!
                </p>
              </div>
            </div>
            <div class="faq-item">
      ...
      <div id="section8" class="faq-section">
        <h3 class="hoverText" style="color:blue">Policy</h3>
        <div class="container">
          <div class="faq">
            <div class="faq-item">
              <div class="faq-question">
                <h3 class="hoverText">What is cancellation policy</h3>
              </div>
              <div class="faq-answer">
                <p class="faq_answer">
                For details on our cancellation policy, please refer to the "Cancellation" section on our website. This will provide you with all the necessary information regarding cancellations and refunds.                </p>
              </div>
            </div>
            <div class="faq-item">
              <div class="faq-question">
                <h3 class="hoverText">What is refund policy</h3>
              </div>
              <div class="faq-answer">
                <p class="faq_answer">
                For details on our refund policy, please check the "refund policy" section on our website. You'll find all the information you need about refunds there.                </p>
              </div>
            </div>
            <div class="faq-item">
              <div class="faq-question">
                <h3 class="hoverText">What are the product shipped policy </h3>
              </div>
              <div class="faq-answer">
                <p class="faq_answer">
                For detailed information regarding our product shipping policy, kindly refer to the "Product Shipped Policy" section available on our website. There, you'll find all the essential details about our shipping procedures.                </p>
              </div>
            </div>
      ...
      <div id="section9" class="faq-section">
        <h3 class="hoverText" style="color:blue">Other Questions</h3>
        <div class="container">
          <div class="faq"> 
            <div class="faq-item">
              <div class="faq-question">
                <h3 class="hoverText">How will I detect fraudulent emails/calls seeking sensitive personal and confidential information?</h3>
              </div>
              <div class="faq-answer">
                <p class="faq_answer">
                If you ever receive an email or a call from someone claiming to be from VOILA, asking for sensitive details like your credit card PIN or passwords, it's crucial to stay cautious. We, at VOILA, or our logistics partners, never request such confidential information. Should you have already disclosed any such details, please report the incident immediately to the appropriate law enforcement authorities.              </p>
              </div>
            </div>
            <div class="faq-item">
              <div class="faq-question">
                <h3 class="hoverText">Can you provide examples of your work?    </h3>
              </div>
              <div class="faq-answer">
                <p class="faq_answer">
                Certainly! You can check out our work samples by following these steps:
                  •	Visit the categories section on our website.
                 •	Choose a model.
                •	View their profile to see all our shoot samples.
                 Alternatively, you can also browse our website at VOILAstudio.in.     </p>
              </div>
            </div>
            <div class="faq-item">
              <div class="faq-question">
                <h3 class="hoverText">What should I prepare before coming to the studio for a photoshoot?    </h3>
              </div>
              <div class="faq-answer">
                <p class="faq_answer">
                Our team will provide additional guidance based on the type of ecommerce photoshoot you book.           </p>
              </div>
            </div>
